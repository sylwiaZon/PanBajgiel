...
export class Settings extends React.Component {
    ...
    //ukrycie dialogu błędnych haseł i wyczyszczenie inputów
    hidePasswordDialog = () => {
                    ...
                    <KeyboardAvoidingView style = {styles.container2}>
                        <View style = {styles.container2}>
                            <View style = {styles.main}>
                                <TouchableOpacity style = {styles.buttonContainer} onPress = {()=>{AsyncStorage.clear(); this.props.navigation.navigate('Auth'); }}>
